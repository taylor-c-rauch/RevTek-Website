  ...
  constructor(props) {
    ...
    this.state = {
      ...
      intern: [
        ...
        { label: "Alumni", place: "/alumni-list" }
      ],
      alumni: [
        { label: "Profile", place: "/profile" },
        { label: "Leaderboard", place: "/leaderboard" },
        { label: "Contracts", place: "/contract-bidding" }
      ],
      admin: [
        { label: "Profile", place: "/profile" },
        { label: "Challenge Manager", place: "/challenge-manager" },
        { label: "Contracts", place: "/contract-editor" },
              ...
              <Toolbar>
                ...
                >
                  <Link to="/login" style={{ textDecoration: "none" }}>
                    <MenuItem onClick={this.handleClose2}>Login</MenuItem>
                  </Link>
                  <Link to="/sign-up" style={{ textDecoration: "none" }}>
                    <MenuItem onClick={this.handleClose2}>Sign-Up</MenuItem>
                  </Link>
                </Menu>
              </Toolbar>
            </AppBar>
              ...
              <Toolbar>
                ...
                {this.state.intern.map(item => (
                  <Link to={item.place}>
                    <Button mini>
                      <Typography>
                        <font color="white">{item.label}</font>
                      </Typography>
                    </Button>
                  </Link>
                ))}
